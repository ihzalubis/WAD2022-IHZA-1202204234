...
<div class="container">
              ...
              <form class="" action="booking.php" method="GET">
                ...
                <div class="col-12">
                  ...
                  <div class="col-12">
                    ...
                    <option value="hrv">Toyota HRV</option>
                    <option value="scirocco">VW Scirocco</option>
                    <option value="mazda">MAZDA CX-3</option>
                    </select>
                  </div>
  ...
  <img src="https://cdn.motor1.com/images/mgl/P33J9G/s1/2022-bmw-3er-limousine.webp" class="img-fluid" alt="..."></div>
</div>
  </main>
